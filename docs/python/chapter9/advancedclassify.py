...
yahookey="dj0zaiZpPVhRaE9UNzBtWUkwRiZkPVlXazlTRWR2WjFsck5HTW1jR285TUEtLSZzPWNvbnN1bWVyc2VjcmV0Jng9ZmE-"
...
def getlocation(address):
  ...
  data=urlopen('http://geo.search.olp.yahooapis.jp/OpenLocalPlatform/V1/geoCoder'+\
               '?appid=%s&location=%s' %
               (yahookey,quote_plus(address))).read()
  doc=parseString(data)
  lat=doc.getElementsByTagName('Geometry')[0].firstChild.nodeValue
  long=doc.getElementsByTagName('Geometry')[1].firstChild.nodeValue  
  print lat
  print long
